...
For Playwright CLI workflows and required validation scenarios, use `skills/dogfooding/SKILL.md`.
...
- For significant changes, dogfood the change with the `dogfooding` skill.
