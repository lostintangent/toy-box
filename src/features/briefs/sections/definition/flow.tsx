...
function PathFlowGraph({
  ...
  const style = {
    "--brief-flow-width": `${layout.width}px`,
    "--brief-flow-height": `${layout.height}px`,
  } as CSSProperties;
  ...
  return (
    <div
      ...
      aria-label="Connected brief flow"
    >
      <div
        style={style}
        className="relative grid gap-3 p-3 lg:mx-auto lg:block lg:h-[var(--brief-flow-height)] lg:w-[var(--brief-flow-width)] lg:p-0"
      >
        <svg
          aria-hidden
