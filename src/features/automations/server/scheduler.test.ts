...
import * as broadcastModule from "@workspace/server/events";
...
let removeSession: typeof streamModule.deleteSessionIfExists;
...
afterAll(() => {
  ...
  mock.module("@workspace/server/events", () => realBroadcastModule);
});
