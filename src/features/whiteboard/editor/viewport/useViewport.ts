...
import { startPinchGesture } from "../gestures/pinch";

/** Owns viewport measurement and wheel input, and offers pan and pinch gestures. */
export function useViewport({
  ...
  return {
    ...
    claimTouchPair: (points) => startPinchGesture(store, points),
