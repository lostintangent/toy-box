...
export function SvgToolbar({
  ...
  return (
    <div
      ...
      className={cn(
        "absolute top-3 left-3 z-10 flex w-max items-center gap-1 overflow-x-auto rounded-md border border-muted-foreground/30 bg-background p-1.5 text-foreground shadow-sm",
      )}
    >
