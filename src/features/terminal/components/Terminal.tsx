...
import { terminalManager } from "../client/terminalManager";
...
export function Terminal({ onClose }: TerminalProps) {
  ...
  return (
    <div className="relative h-full min-h-0 p-2 pb-0">
      <div ref={containerRef} className="h-full w-full bg-panel" />

      {/* Loading skeleton (fades in after delay so quick reconnects don't flash) */}
      {!isPtyReady && (
        <div className="absolute inset-0 flex items-start p-2 opacity-0 animate-in fade-in fill-mode-forwards delay-200">
