...
import { replaySdkHistory } from "./historyReplay";
...
describe("history replay", () => {
  test("replays compaction lifecycle through the shared projector and still lands idle", () => {
    const events = [
    ...
    const state = replaySdkHistory("history-replay-session", events);
