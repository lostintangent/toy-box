...
import { APP_DEPENDENCIES } from "@/lib/apps/runtime";
import { APP_ICON_NAMES } from "@/lib/apps/icons";
import { parseAppStateSchema } from "@/lib/apps/stateSchema";
...
function appSdkSource(stateSchema: AppStateDefinition["schema"]): string {
  return `export * from "./src/lib/apps/sdk";
import type { AppHandle } from "./src/lib/apps/sdk";
