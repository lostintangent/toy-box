// Styling for a pane shell's floating overlay controls — the small icon-buttons that sit
...
export const PANE_OVERLAY_BUTTON_CLASS = `rounded-md border ${PANE_OVERLAY_BORDER_CLASS} bg-background/90 p-1.5 shadow-sm backdrop-blur-sm hover:bg-background hover:shadow-md`;
