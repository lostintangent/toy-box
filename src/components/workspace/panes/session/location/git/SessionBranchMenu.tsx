import { FileOutput, GitBranch, GitFork, GitMerge, Loader2 } from "lucide-react";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
...
export type WorktreeBranchActions = {
...
type SessionBranchMenuProps = WorktreeBranchActions & {
...
export function SessionBranchMenu({
  branch,
  repository,
  gitRoot,
  cwd,
