...
import { DirectoryBrowserDialog } from "@/components/config/DirectoryBrowserDialog";
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuItem,
                ...
                return (
                  ...
                  >
                    ...
                    <span className="flex min-w-0 flex-col">
                      ...
                      <span className="truncate text-2xs text-muted-foreground">{option.cwd}</span>
                    </span>
                  </DropdownMenuItem>
                );
              })
